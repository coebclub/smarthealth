  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark fixed-top sticky-top" style={{ backgroundColor: '#1b558b' }}>
      <div className="container">
        <Link className="navbar-brand title-animate" to="/" style={{ fontWeight: 'bold', fontSize: '1.5rem' }}>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            {isLoggedIn ? (
              ...
              <>
                <li className="nav-item">
                  <Link className="nav-link text-animate" to="/Authentication-page" style={{ padding: '10px 15px' }} onClick={closeMenu}>
